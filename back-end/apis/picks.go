...
func demoScript(driver neo4j.Driver) {
	...
	queries.AddGame(driver, "UTA", "Utah Jazz", "NOP", "New Orleans Pelicans", "2021-5-12", "UTA",
	...
	queries.AddGame(driver, "LAC", "Los Angeles Clippers", "LAL", "Los Angeles Lakers", "2021-5-12", "LAL",
		...
		"https://cdn.wallpapersafari.com/8/37/AIVuoY.jpg",
		"western")
	queries.AddGame(driver, "ORL", "Orlando Magic", "BKN", "Brooklyn Nets", "2021-5-12", "ORL",
		...
		"eastern")
	queries.AddGame(driver, "MEM", "Memphis Grizzlies", "POR", "Portland Trailblazers", "2021-5-12", "POR",
		...
		"western")
	queries.AddGame(driver, "PHX", "Phoenix Suns", "WAS", "Washington Wizards", "2021-5-12", "PHX",
